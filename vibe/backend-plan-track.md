...
- [ ] Опубликовать обе feature-ветки и PR по разрешению владельца.
- [ ] Настроить привилегированный SSH-ключ Actions, environment и secrets:
  автоматическая проверка запросила отдельное согласие, ключ не создан.
- [ ] Выполнить и проверить первый реальный GitHub CI/CD run после публикации.
